...
import { TaskService } from 'app/entities/jhipsterSampleApplication860/task/service/task.service';
...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 18497 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 17879 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 1102 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 2499 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 23929 };
      job.tasks = [task];
      const employee: IEmployee = { id: 2539 };
      job.employee = employee;
