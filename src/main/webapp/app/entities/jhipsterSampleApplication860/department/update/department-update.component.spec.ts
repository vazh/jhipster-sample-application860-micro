...
import { LocationService } from 'app/entities/jhipsterSampleApplication860/location/service/location.service';
...
describe('Department Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call location query and add missing value', () => {
      ...
      const location: ILocation = { id: 24934 };
      department.location = location;

      const locationCollection: ILocation[] = [{ id: 24015 }];
    ...
    it('Should update editForm', () => {
      const department: IDepartment = { id: 456 };
      const location: ILocation = { id: 19185 };
      department.location = location;
