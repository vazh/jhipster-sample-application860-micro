...
import { JobService } from 'app/entities/jhipsterSampleApplication860/job/service/job.service';
import { IDepartment } from 'app/entities/jhipsterSampleApplication860/department/department.model';
import { DepartmentService } from 'app/entities/jhipsterSampleApplication860/department/service/department.service';
import { IEmployee } from 'app/entities/jhipsterSampleApplication860/employee/employee.model';
import { EmployeeService } from 'app/entities/jhipsterSampleApplication860/employee/service/employee.service';
...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 22543 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 25604 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 19417 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 7124 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 10980 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 26277 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 11111 };
      jobHistory.job = job;
      const department: IDepartment = { id: 24435 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 24745 };
      jobHistory.employee = employee;
