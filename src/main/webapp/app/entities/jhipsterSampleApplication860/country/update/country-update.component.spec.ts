...
import { RegionService } from 'app/entities/jhipsterSampleApplication860/region/service/region.service';
...
describe('Country Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call region query and add missing value', () => {
      ...
      const region: IRegion = { id: 26036 };
      country.region = region;

      const regionCollection: IRegion[] = [{ id: 8707 }];
