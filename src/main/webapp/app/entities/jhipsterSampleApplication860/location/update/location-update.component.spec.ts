...
import { ICountry } from 'app/entities/jhipsterSampleApplication860/country/country.model';
import { CountryService } from 'app/entities/jhipsterSampleApplication860/country/service/country.service';
...
describe('Location Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call country query and add missing value', () => {
      ...
      const country: ICountry = { id: 5793 };
      location.country = country;

      const countryCollection: ICountry[] = [{ id: 24772 }];
    ...
    it('Should update editForm', () => {
      const location: ILocation = { id: 456 };
      const country: ICountry = { id: 7996 };
      location.country = country;
